...
#Parte 1:
    ...
    - Adicione as prorpriedades: marca, modelo, preco, cor, autonomia, capacidadeTanque, imagemURL.
    - Adicione um metodo calcularDistanciaMaxima, que retornará a autonomia, capacidadeTanque.
    - Adicione um metodo exibirDetalhes, que rerornará os dados concatenados de:
...
#Parte 2:
   ...
   #exercicio:
     - Adicione ao veiculo anoFabricação 
     - Adicione uma função que retorne se o veiculo e insento de ipva naquele ano
